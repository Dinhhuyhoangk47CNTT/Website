...
builder.Services.AddScoped<ITienPhongRepository, TienPhongRepository>();
builder.Services.AddScoped<ITienDienRepository, TienDienRepository>();
builder.Services.AddScoped<ITienNuocRepository, TienNuocRepository>();
builder.Services.AddScoped<IVanBanRepository, VanBanRepository>();
...
builder.Services.AddScoped<ITienDienService, TienDienService>();
builder.Services.AddScoped<ITienNuocService, TienNuocService>();
builder.Services.AddScoped<ITienPhongService, TienPhongService>();
...
app.UseEndpoints(endpoints =>
{
  ...
  defaults: new { controller = "Phong", action = "BaoCao" });
    ...
    endpoints.MapAreaControllerRoute(
    name: "ThanhToanTienPhong",
    areaName: "Admin",
    pattern: "admin/thanh-toan-tien-phong",
    defaults: new { controller = "TienPhong", action = "Index" });

    endpoints.MapAreaControllerRoute(
    name: "ThanhToanTienDien",
    areaName: "Admin",
    pattern: "admin/thanh-toan-tien-dien",
    defaults: new { controller = "TienDien", action = "Index" });

    endpoints.MapAreaControllerRoute(
    name: "ThanhToanTienNuoc",
    areaName: "Admin",
    pattern: "admin/thanh-toan-tien-nuoc",
    defaults: new { controller = "TienNuoc", action = "Index"});
