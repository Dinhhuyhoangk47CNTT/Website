(function ($) {
    ...
    self.ValidateUser = function () {        
        ...
        $("#form-submit").validate({
            ...
            messages:
            {
                ...
                ChucVuPhong: {
                    required: "Vui lòng chọn chức vụ phòng"
                }
            },
    ...
    self.GetValue = function () {
        ...
        self.HopDong.ChucVuPhong = $("#ChucVuPhong").val();
    ...
    Set.SetValue = function () {
        ...
        $("#ChucVuPhong").val(self.HopDong.ChucVuPhong);
