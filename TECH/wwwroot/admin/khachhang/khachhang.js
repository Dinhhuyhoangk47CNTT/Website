(function ($) {
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.Status) {
                    ...
                    self.KhachHang.MaSV = resUser.MaSV;
                    self.KhachHang.Nganh = resUser.Nganh;
                    self.KhachHang.Khoa = resUser.Khoa;
                    self.KhachHang.SDTGiaDinh = resUser.SDTGiaDinh;
                    self.KhachHang.TrangThai = resUser.TrangThai;
                    self.KhachHang.ChucVu = resUser.ChucVu;
                    self.KhachHang.TenPhong = resUser.TenPhong;
                    Set.SetValue();
                }
            },
            error: function () {
        ...
        $("#form-submit").validate({
            ...
            messages:
            {
                MaSV: {
                    ...
                    minlength: "Mã sinh viên tối thiểu 8 ký tự"
                },
                TenKH: {
                ...
                Nganh: {
                    required: "Vui lòng nhập vào ngành"
                },
                Khoa: {
                    required: "Vui lòng nhập vào khoá học"
                },
                SDTGiaDinh: {
                    required: "Vui lòng nhập vào số điện thoại gia đình",
                    headphone: "Số điện thoại không hợp lệ"
                }
                //TenDangNhap: {
    ...
    self.GetValue = function () {
        ...
        self.KhachHang.MaSV = $("#MaSV").val();
        self.KhachHang.Nganh = $("#Nganh").val();
        self.KhachHang.Khoa = $("#Khoa").val();
        self.KhachHang.SDTGiaDinh = $("#SDTGiaDinh").val();
        self.KhachHang.TrangThai = $("#TrangThai").val();
        self.KhachHang.ChucVu = $("#ChucVu").val();
        self.KhachHang.TenPhong = $("#TenPhong").val();
    ...
    Set.SetValue = function () {
        if (self.User.Id !== null && self.User.Id !== '') {
            ...
            $("#MaSV").val(self.KhachHang.MaSV);
            $("#Nganh").val(self.KhachHang.Nganh);
            $("#Khoa").val(self.KhachHang.Khoa);
            $("#SDTGiaDinh").val(self.KhachHang.SDTGiaDinh);
            $("#TrangThai").val(self.KhachHang.TrangThai);
            $("#ChucVu").val(self.KhachHang.ChucVu);
            $("#TenPhong").val(self.KhachHang.TenPhong);
    ...
    self.RenderHtmlByObject = function (view) {
        ...
        $("#Nganh").val(view.Nganh);
        $("#Khoa").val(view.Khoa);
        $("#SDTGiaDinh").val(view.SDTGiaDinh);
        $("#TrangThai").val(view.TrangThai);
        $("#ChucVu").val(view.ChucVu);
