(function ($) {
    ...
    self.RenderTableHtml = function (data) {
        ...
        if (data != "" && data.length > 0) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += "<td>" + item.TongLuongNuocTieuThu + "</td>";
    ...
    self.GetDataPaging = function (isPageChanged) {
        ...
        $.ajax({
            url: '/Admin/ThongKe/ThongKeTienNuocPaging',
            type: 'GET',
    ...
    $(document).ready(function () {
        ...
        $(".btn-export-excel").click(function () {
            window.location.href = "/admin/thongke/ThongKeTienNuocExcel";
        });
    })
})(jQuery);